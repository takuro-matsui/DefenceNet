...
### RemoveNet
Fence images are created by combining fence masks with the clean outdoor images from UCID dataset and from the BSD dataset. Training dataset was created by runnning fllowing: 
```
